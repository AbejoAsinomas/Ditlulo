...
<body background="imgs/abstract-envelope.png"
      ...
      <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
        ...
        <table class="table table-striped">
          ...
          if (isset($_GET['btns']) /*&& $_GET['Buscar']!=null*/) {
            ...
            $query = "SELECT * FROM servicios WHERE Id LIKE '$buscar' or Id LIKE '$buscar'";
            ...
            if (mysqli_num_rows($cons) !== 0) {
              while ($vec = mysqli_fetch_array($cons)) { ?>
                <tr>
                  ...
                  <td>
                    <a href='mostrarservicios.php?Id=<?php echo $vec[0] ?>'>Ver</a>
 ...
 echo "Escribe un indicio de búsqueda.";
    ...
    <!-- Inicio Carousel -->
    <!-- 
    <div id="carouselExampleIndicators" style="width: 600px; height: auto;display: block; margin: auto;"
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="imgs/busca.png">
        </div>
        <div class="carousel-item">
          <img src="imgs/encuentra.png">
        </div>
        <div class="carousel-item">
          <img src="imgs/trabajo.png">
        </div>
      </div>
    ...
    <!-- publicacion -->
    <div class="container" style="padding: 1em;">
      <h1 style="text-align: center;">Publicar servicio</h1>
      <form class="row g-3 needs-validation" novalidate action="regservicios.php" method="post">
        <div class="col-md-4 position-relative">
          <label for="validationTooltip01" class="form-label">Nombre del servicio</label>
          <input type="text" class="form-control" name="tipotrabajo" id="validationTooltip01" required>
        </div>
        <div class="col-md-4 position-relative">
          <label for="validationTooltip02" class="form-label">Precio</label>
          <input type="text" class="form-control" name="precio" id="validationTooltip02" required>
        </div>
        <div class="col-md-4 position-relative">
          <label for="validationTooltipUsername" class="form-label">Correo electrónico</label>
          <div class="input-group has-validation">
            <span class="input-group-text" id="validationTooltipUsernamePrepend">@</span>
            <input type="text" class="form-control" id="validationTooltipUsername" name="correo"
              aria-describedby="validationTooltipUsernamePrepend" required>
          </div>
        </div>
        <div class="col-md-6 position-relative">
          <label for="validationTooltip03" class="form-label">Descripción</label>
          <input type="text" class="form-control" id="validationTooltip03" name="descripcion" required>
        </div>
        <div class="col-md-6 position-relative">
          <label for="validationTooltip04" class="form-label">Asistencia de trabajo</label>
          <select class="form-select" id="validationTooltip04" name="tipoasistencia" required>
        ...
        <!-- <div class="col-md-3"> 
        <label for="validationServer01" class="form-label">Confirma tu contraseña</label>
        <input type="password" class="form-control is-valid" id="validationServer01"required>
        <div class="valid-feedback">
          ¡Buena suerte!
        </div>
      </div> -->
        <div class="col-12">
          <button class="btn btn-dark" type="submit">Hacer publicación</button>
        </div>
      </form>
    </div>
    <!-- fin -->
    ...
    <div class="container">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="imgs/trabajos.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">Nuestra finalidad</h5>
              <p class="card-text">La finalidad de DITLULO es hacer que las personas puedan conseguir trabajos
                facilmente
                desde sus hogares. <br>Mucha suerte en tu trabajo soñado. </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget subscribe no-box">
              <h5 class="widget-title">DitLulo<span></span></h5>
              <p>Una forma sencilla de encontrar trabajo.</p>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget no-box">
              ...
              <ul class="thumbnail-widget">
                <li>
                  <div class="thumb-content"><a href="#.">Link 1</a></div>
                </li>
                <li>
                  <div class="thumb-content"><a href="#.">Link 2</a></div>
                </li>
                <li>
                  <div class="thumb-content"><a href="#.">Link 3</a></div>
                </li>
                <li>
                  <div class="thumb-content"><a href="#.">Link 4</a></div>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget no-box">
              <h5 class="widget-title">Apoyanos<span></span></h5>
              <p>Una pequeña donación monetarea para seguir mejorando la página.</p>
              <a class="btn" href="#" target="_blank">¡¡Gracias!!</a>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            ...
            <div class="widget no-box">
              ...
              <p><a href="mailto:info@domain.com" title="glorythemes">ditlulo@info.com</a></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <p>Copyright DitLulo © 2023. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
